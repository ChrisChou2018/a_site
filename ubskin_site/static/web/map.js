...
;!function (win, $, undefined) {
	var SVGMap = (function () {
		...
		SVGMap.prototype.options = {
			...
			stateInitColor: 'cbcbcb',
			stateHoverColor: '037bc3',
			stateSelectedColor: '037bc3',
	...
	$('#ChinaMap').SVGMap({
		...
		stateData: {
	                'gansu': {'stateInitColor': 0},
									...
									'sichuan': {'stateInitColor': 0},
									'chongqing': {'stateInitColor': 0},
									'hubei': {'stateInitColor': 0},
									'anhui': {'stateInitColor': 0},
									'zhejiang': {'stateInitColor': 0},
									'hunan': {'stateInitColor': 1},
									'heilongjiang': {'stateInitColor': 1},
									'jilin': {'stateInitColor': 1},
									'liaoning': {'stateInitColor': 1},
									'shaanxi': {'stateInitColor': 1},
									'shanxi': {'stateInitColor': 1},
									'henan': {'stateInitColor': 1},
									'jiangsu': {'stateInitColor': 1},
									'shandong': {'stateInitColor': 1},
									'hebei': {'stateInitColor': 1},
									'beijing': {'stateInitColor': 1},
									'tianjin': {'stateInitColor': 1},

            	},
		clickCallback: function(stateData, obj){
            //$('#ClickCallback').html('点击了：'+((stateData)[obj.id] && (stateData)[obj.id].baifenbi || obj.id));
						$('#'+((stateData)[obj.id] && (stateData)[obj.id].baifenbi || obj.id)).show().siblings(".map_show").hide();
						$("#map_select option[value="+((stateData)[obj.id] && (stateData)[obj.id].baifenbi || obj.id)+"]").attr("selected", true);
						$('.'+((stateData)[obj.id] && (stateData)[obj.id].baifenbi || obj.id)).css("color","#ffffff").siblings(".map_dd").css("color","#333333");
        }
	});
	
			
	$('#map_select').change(function(){ 
	  $('#'+$(this).children('option:selected').val()).show().siblings(".map_show").hide();
	}) 
});